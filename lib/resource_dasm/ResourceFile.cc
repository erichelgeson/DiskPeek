...
// Code/executable decoder stubs — emulators not vendored


// Stub implementations for code/executable decoders (emulators not vendored)
#define STUB_DECODER(RetType, Name, ...)   RetType ResourceFile::Name(__VA_ARGS__) const { throw std::runtime_error("Code decoder not available"); }   RetType ResourceFile::Name(std::shared_ptr<const Resource>) { throw std::runtime_error("Code decoder not available"); }   RetType ResourceFile::Name(const void*, size_t) { throw std::runtime_error("Code decoder not available"); }

STUB_DECODER(ResourceFile::DecodedCode0Resource, decode_CODE_0, int16_t id, uint32_t type)
STUB_DECODER(ResourceFile::DecodedCodeResource, decode_CODE, int16_t id, uint32_t type)
STUB_DECODER(ResourceFile::DecodedDriverResource, decode_DRVR, int16_t id, uint32_t type)
STUB_DECODER(ResourceFile::DecodedDecompressorResource, decode_dcmp, int16_t id, uint32_t type)
STUB_DECODER(ResourceFile::DecodedRSSCResource, decode_RSSC, int16_t id, uint32_t type)

PEFFile ResourceFile::decode_pef(int16_t, uint32_t) const { throw std::runtime_error("PEF decoder not available"); }
PEFFile ResourceFile::decode_pef(std::shared_ptr<const Resource>) { throw std::runtime_error("PEF decoder not available"); }
PEFFile ResourceFile::decode_pef(const void*, size_t) { throw std::runtime_error("PEF decoder not available"); }

ResourceFile::DecodedPEFDriver ResourceFile::decode_expt(int16_t, uint32_t) const { throw std::runtime_error("PEF decoder not available"); }
ResourceFile::DecodedPEFDriver ResourceFile::decode_expt(std::shared_ptr<const Resource>) { throw std::runtime_error("PEF decoder not available"); }
ResourceFile::DecodedPEFDriver ResourceFile::decode_expt(const void*, size_t) { throw std::runtime_error("PEF decoder not available"); }

ResourceFile::DecodedPEFDriver ResourceFile::decode_nsrd(int16_t, uint32_t) const { throw std::runtime_error("PEF decoder not available"); }
ResourceFile::DecodedPEFDriver ResourceFile::decode_nsrd(std::shared_ptr<const Resource>) { throw std::runtime_error("PEF decoder not available"); }
ResourceFile::DecodedPEFDriver ResourceFile::decode_nsrd(const void*, size_t) { throw std::runtime_error("PEF decoder not available"); }
...
ResourceFile::DecodedPictResource ResourceFile::decode_PICT_data(
  ...
  try {
    ...
    // picttoppm fallback not available (Subprocess not vendored)
    throw;
  }
}

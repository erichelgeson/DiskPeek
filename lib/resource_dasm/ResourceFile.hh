...
// Stubbed types from Emulators/M68KEmulator.hh (not vendored)
struct JumpTableEntry {
  int16_t code_resource_id;
  uint16_t offset;
};

// Forward declaration stub for PEFFile (not vendored)
class PEFFile {
public:
  PEFFile() = default;
  explicit PEFFile(const char*) {}
  PEFFile(const char*, const std::string&) {}
};
